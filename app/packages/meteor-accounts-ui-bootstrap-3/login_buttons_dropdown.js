(function() {
	...
	var login = function() {
		...
		var ldapOptions = {
      dn: "cn=" + username + ",ou=Kerberos,ou=Kennungen,o=lrz-muenchen,c=de",
      search: "(&(objectclass=Person)(cn=" + username + "))"
		...
		if (username == 'admin' || username == 'AUser') {
			Meteor.loginWithPassword({username: username}, password, callback);
		} else {
